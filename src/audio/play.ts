...
export interface AudioPlayOpt {
     ...
     * BUILDNANA's default volume node. Defaults to undefined, i.e. use BUILDNANA's volume node.
     */
    connectTo?: AudioNode;
}
...
export interface AudioPlay {
     ...
     * and connect it to the passed-in audio node, or to Buildnana's default volume node
