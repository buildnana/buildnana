...
/**
 * Context handle that contains every BUILDNANA function.
 *
...
export interface BUILDNANACtx {
     ...
     *
     * [Guide about fake mouse](https://v4000.buildnana.com/guides/fake_mouse/)
     *
     ...
     * loadSprite("apple", "https://play.buildnana.com/sprites/apple.png");
     *
    ...
    /**
     * Load a sprite with Aseprite spritesheet JSON. You should use "array" in the export options and have tags enabled, that way BUILDNANA can load tagged frames as animations.
     *
     ...
     * will transition to the error screen after a timeout (which is set by {@link BUILDNANAOpt["loadTimeout"]|BUILDNANAOpt.loadTimeout}).
     *
     ...
     *     // predefined functions to get the default value by BUILDNANA
     *     return def_vert();
     * }`,
     ...
     * The options (and caveats) are described at {@link BUILDNANAOpt["fixedUpdateMode"]|BUILDNANAOpt.fixedUpdateMode}.
     *
     * @group Physics
     * @experimental
     */
    ...
    /**
     * The exported Picture class to BUILDNANA Context.
     *
     * @example
     * ```js
     * const k = buildnana();
     ...
     * @group Plugins
     */
    plug<T extends Record<string, any>>(
        plugin: BUILDNANAPlugin<T>,
    ): BUILDNANACtx & T;
    /**
    ...
    /**
     * This enum defines the 6 places where a new system can hook into in BUILDNANA's update loop.
     *
    ...
    BLACK: Color;
    /**
     * The canvas DOM BUILDNANA is currently using.
     *
     * @since v2000.0
     * @group Info
     */
    ...
    /**
     * Current BUILDNANA library version.
     *
     * @since v3000.0
     * @group Info
     */
