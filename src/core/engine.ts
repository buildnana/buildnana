// The engine is what BUILDNANA needs for running and proccesing all it's stuff
...
window.buildnana_assetsAliases = {};

/**
 * Creates all necessary contexts and variables for running a BUILDNANA instance.
 *
 * @ignore
 *
 ...
 * @returns Engine.
 */
export const createEngine = (gopt: BUILDNANAOpt) => {
    // Default options
    ...
    return {
        ...
        sceneScope,
        appScope,
        // Patch, k it's only avaible after running buildnana()
        k: null as unknown as BUILDNANACtx,
        startLoop() {
            startEngineLoop(
                app,
                game,
