...
export interface LoadSpriteOpt {
    ...
    filter?: TexFilter;
    /**
     * If you've already packed your spritesheet, you can set this to false to tell BUILDNANA not to repack it
...
export function loadBean(name: string = "bean"): Asset<SpriteData> {
    if (!_k.game.defaultAssets.bean) {
        throw new Error("You can't use bean in buildnana/mini");
    }
