...
/**
 * The basic unit of object in BUILDNANA. The player, a butterfly, a tree, or even a piece of text.
 *
 * @group Game Obj
 * @subgroup Types
 */
...
export type PluginList<T> = Array<T | BUILDNANAPlugin<any>>;
...
/**
 * A gamepad definition. Used in {@link BUILDNANAOpt `BUILDNANAOpt`}
 *
 * @group Input
 * @subgroup Gamepad
 */
...
export interface BUILDNANAOpt {
     ...
     *
     * Currently this is only used by {@link BUILDNANACtx.loadBitmapFontFromSprite}.
     *
     * @default 3000
     */
    loadTimeout?: number;
 ...
 * @group Plugins
 */
export type BUILDNANAPlugin<T> = (
    k: BUILDNANACtx,
) => T | ((...args: any) => (k: BUILDNANACtx) => T);
