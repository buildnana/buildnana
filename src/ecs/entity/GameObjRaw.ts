...
export interface GameObjRaw {
    ...
    onKeyDown: BUILDNANACtx["onKeyDown"];
    onKeyPress: BUILDNANACtx["onKeyPress"];
    onKeyPressRepeat: BUILDNANACtx["onKeyPressRepeat"];
    onKeyRelease: BUILDNANACtx["onKeyRelease"];
    onCharInput: BUILDNANACtx["onCharInput"];
    onMouseDown: BUILDNANACtx["onMouseDown"];
    onMousePress: BUILDNANACtx["onMousePress"];
    onMouseRelease: BUILDNANACtx["onMouseRelease"];
    onMouseMove: BUILDNANACtx["onMouseMove"];
    onTouchStart: BUILDNANACtx["onTouchStart"];
    onTouchMove: BUILDNANACtx["onTouchMove"];
    onTouchEnd: BUILDNANACtx["onTouchEnd"];
    onScroll: BUILDNANACtx["onScroll"];
    onGamepadButtonDown: BUILDNANACtx["onGamepadButtonDown"];
    onGamepadButtonPress: BUILDNANACtx["onGamepadButtonPress"];
    onGamepadButtonRelease: BUILDNANACtx["onGamepadButtonRelease"];
    onGamepadStick: BUILDNANACtx["onGamepadStick"];
    onButtonDown: BUILDNANACtx["onButtonDown"];
    onButtonPress: BUILDNANACtx["onButtonPress"];
    onButtonRelease: BUILDNANACtx["onButtonRelease"];
    onTabShow: BUILDNANACtx["onTabShow"];
    onTabHide: BUILDNANACtx["onTabHide"];
    onShow: BUILDNANACtx["onShow"];
    onHide: BUILDNANACtx["onHide"];
}
